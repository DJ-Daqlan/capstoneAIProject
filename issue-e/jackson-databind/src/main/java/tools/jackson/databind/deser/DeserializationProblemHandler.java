...
public abstract class DeserializationProblemHandler
{
    ...
    /**
     * Method called when a <code>null</code> token is encountered for a type that
     * does not allow null values (like primitives) and feature
     ...
     *    standard exception caller would throw
     *  </li>
     * <li>Return actual value (of type <code>targetType</code>) to use as replacement;
     *    value may be `null` as well as expected target type.
     *  </li>
     * </ul>
     *
     ...
     * @param targetType Type that does not allow null values
     * @param failureMsg Informational message that would be thrown as part of
     *    exception, if problem still not resolved
     *
     * @return Either {@link #NOT_HANDLED} to indicate that handler does not know
     *    what to do (and exception may be thrown), or value to use (possibly
     *    <code>null</code>
